...
import { MOCK_DEAL_ROOMS, MOCK_OFFERS } from "@/lib/mock-data";
import { DealRoom, Offer } from "@/lib/types";

export default function DealsDashboardPage() {
  const { user } = useAuth();
  const [deals, setDeals] = useState<DealRoom[]>(MOCK_DEAL_ROOMS);
              ...
              >
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <h3 className="text-base font-bold text-white uppercase">
                        {deal.product?.title || "VividAI • Short-Form Video SaaS"}
                      </h3>
                      <p className="text-xs text-zinc-400">
                        Buyer: @{deal.buyer?.username || "alexmercer"} • Seller: @{deal.seller?.username || "syntaxlabs"}
                      </p>
                    </div>
                  </div>
                ...
                <div className="border-t border-border pt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                  <div className="flex items-center gap-2 text-zinc-400 font-sans">
                    ...
                    <span>Inspection Period: 48 Hours • Escrow Protected by Auraminator</span>
                  </div>
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="space-y-1">
                    ...
                    <h3 className="text-base font-bold text-white uppercase">
                      {offer.product?.title || "ApexEscrow Core"}
                    </h3>
                  ...
                  <div className="text-left sm:text-right font-mono">
                    ...
                    <span className="text-[10px] text-zinc-500 block">
                      List Price: {formatINR(offer.product?.base_price || 450000)}
                    </span>
                  </div>
                </div>
